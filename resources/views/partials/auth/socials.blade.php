...
<div class="panel-heading"><strong>Easy Mode:</strong> Connect With a Social Network</div>
<div class="panel-body">
<div class="col-md-6 col-md-offset-4">
    <div class="btn-group" role="group" aria-label="...">
        <a href="{{ url('/social/facebook') }}" type="button" class="btn btn-facebook"><i class="fa fa-facebook"></i></a>
        <a href="{{ url('/social/twitter') }}" type="button" class="btn btn-twitter"><i class="fa fa-twitter"></i></a>
        <a href="{{ url('/social/google') }}" type="button" class="btn btn-google"><i class="fa fa-google"></i></a>
